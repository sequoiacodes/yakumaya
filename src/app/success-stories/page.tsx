      ...
      <section className="relative h-[40vh] flex items-center">
        ...
        <div className="container mx-auto px-4 z-10 text-white">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4">Success Stories</h1>
            <p className="text-xl">Real stories of change and transformation from the communities we work with.</p>
          </div>
        </div>
      </section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {[
                  ...
                  },
                  {
                    ...
                    date: "April 2023",
                    image: "/placeholder.svg?height=400&width=600&text=Gorkha School",
                  ...
                  },
                  {
                    ...
                    date: "February 2023",
                    image: "/placeholder.svg?height=400&width=600&text=Ram's Home",
                    slug: "rams-new-home",
                  },
                  {
                    ...
                    date: "January 2023",
                    image: "/placeholder.svg?height=400&width=600&text=Women's Cooperative",
                  ...
                  },
                  {
                    ...
                    date: "September 2022",
                    image: "/placeholder.svg?height=400&width=600&text=Maya's Farm",
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <div className="flex items-center">
                          ...
                          <span className="text-sm text-gray-600 dark:text-gray-400">{story.date}</span>
                        </div>
                      </div>
                      <h3 className="text-xl font-bold mb-2">{story.title}</h3>
                      <p className="text-gray-600 dark:text-gray-400 mb-4 line-clamp-3">{story.excerpt}</p>
            ...
            <TabsContent value="disaster-relief" className="mt-0">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {[
                  ...
                  {
                    title: "Winter Relief Brings Warmth to High-Altitude Communities",
                    excerpt:
                      "Our winter relief program provided essential supplies to families in high-altitude areas facing extreme cold conditions.",
                    category: "Disaster Relief",
                    location: "Humla District",
                    date: "January 2023",
                    image: "/placeholder.svg?height=400&width=600&text=Winter Relief",
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-900">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <div className="inline-block bg-primary/10 text-primary px-4 py-1 rounded-full mb-4">Featured Story</div>
              <h2 className="text-3xl font-bold mb-4">Sunita&apos;s Journey to Financial Independence</h2>
              <div className="flex items-center space-x-4 mb-4">
                <div className="flex items-center">
                  <MapPin className="h-4 w-4 text-primary mr-2" />
                  <span className="text-sm text-gray-600 dark:text-gray-400">Kathmandu</span>
                </div>
                <div className="flex items-center">
                  <Calendar className="h-4 w-4 text-primary mr-2" />
                  <span className="text-sm text-gray-600 dark:text-gray-400">May 2023</span>
                </div>
              </div>
              <p className="text-lg text-gray-700 dark:text-gray-300 mb-6">
                &ldquo;Before joining the vocational training program, I was struggling to make ends meet. Now, with my own
                tailoring business, I can support my family and send my children to school.&rdquo;
              </p>
              <p className="text-lg text-gray-700 dark:text-gray-300 mb-6">
                Sunita Tamang, a 35-year-old mother of two from Kathmandu, transformed her life after participating in
                our vocational training program. With the skills she gained and the seed funding provided, she
                established her own tailoring business that now employs three other women from her community.
              </p>
              <Button asChild>
                <Link href="/success-stories/sunita-financial-independence">Read Full Story</Link>
              </Button>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w3xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 mb-8">
              Have you been impacted by our work? We&apos;d love to hear your story and possibly feature it on our website.
            </p>
