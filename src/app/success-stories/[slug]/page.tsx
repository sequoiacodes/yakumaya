      ...
      >
        ...
        <div className="container mx-auto px-4 z-10 text-white">
          <div className="max-w-4xl">
            <div className="inline-block bg-primary text-white px-4 py-1 rounded-full mb-4">
              {story.category}
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="prose prose-lg max-w-none">
                {story.testimonial && (
                  <blockquote
                    className={`text-xl italic font-medium my-8 border-l-4 border-primary pl-4 ${
            ...
            <div className="lg:col-span-1">
              ...
              <div className="bg-primary text-white p-6 rounded-lg mb-8">
                ...
                <p className="mb-4">
                  Your donation can help us create more success stories like
                  this one.
                </p>
              ...
              >
                ...
                >
                  Join us in making a difference in communities across Nepal.
                </p>
