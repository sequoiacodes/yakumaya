...
export default function NewsDetailPage({ params }: NewsDetailPageProps) {
  ...
  const relatedArticles = newsArticles
    .filter((a) => a.id !== article.id && a.categories.some((category) => article.categories.includes(category)))
    .slice(0, 3)
            ...
            <div className="flex items-center space-x-4 mb-4">
              {article.categories.map((category, index) => (
                <Link
                  ...
                  className="bg-primary/80 px-3 py-1 rounded-full text-sm hover:bg-primary"
                >
                  {category}
                </Link>
              ))}
                ...
                <div className="space-y-6">
                  {relatedArticles.length > 0 ? (
                    relatedArticles.map((relatedArticle) => (
                      <div key={relatedArticle.id} className="flex flex-col gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">{relatedArticle.date}</p>
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-900">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">More News & Updates</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {newsArticles
              ...
              .slice(0, 3)
              .map((newsItem) => (
                <div key={newsItem.id} className="bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-lg">
                  <div className="relative h-48">
                    <Image
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 mb-4 line-clamp-2">{newsItem.excerpt}</p>
                    <Button asChild variant="outline">
