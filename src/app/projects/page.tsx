      ...
      <section className="relative h-[40vh] flex items-center">
        ...
        <div className="container mx-auto px-4 z-10 text-white">
          <div className="max-w-3xl">
            ...
            <p className="text-xl">
              Explore our ongoing and completed projects that are creating sustainable impact across Nepal.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
              Our projects focus on creating sustainable solutions to the most pressing challenges faced by communities
              across Nepal.
            </p>
          </div>
                ...
                {[
                  {
                    ...
                    image: "/placeholder.svg?height=400&width=600&text=School Rebuilding",
                    progress: 75,
                    target: "$120,000",
                    raised: "$90,000",
                  ...
                  },
                  {
                    ...
                    image: "/placeholder.svg?height=400&width=600&text=Women Entrepreneurs",
                    progress: 60,
                    target: "$80,000",
                    raised: "$48,000",
                  ...
                  },
                  {
                    ...
                    image: "/placeholder.svg?height=400&width=600&text=Mobile Clinic",
                    progress: 85,
                    target: "$45,000",
                    raised: "$38,250",
                  ...
                  },
                  {
                    ...
                    image: "/placeholder.svg?height=400&width=600&text=Agriculture",
                    progress: 50,
                    target: "$70,000",
                    raised: "$35,000",
                  ...
                  },
                  {
                    ...
                    image: "/placeholder.svg?height=400&width=600&text=Youth Skills",
                    progress: 65,
                    target: "$55,000",
                    raised: "$35,750",
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {[
                  ...
                  },
                  {
                    ...
                    image: "/placeholder.svg?height=400&width=600&text=Learning Center",
                  ...
                  },
                  {
                    ...
                    image: "/placeholder.svg?height=400&width=600&text=Maternal Health",
                  ...
                  },
                  {
                    ...
                    image: "/placeholder.svg?height=400&width=600&text=School Meals",
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {[
                  ...
                  },
                  {
                    ...
                    image: "/placeholder.svg?height=400&width=600&text=Digital Literacy",
                  ...
                  },
                  {
                    ...
                    image: "/placeholder.svg?height=400&width=600&text=Irrigation",
                  ...
                  <Card key={index} className="overflow-hidden border-none shadow-lg hover:shadow-xl transition-shadow">
                    ...
                    <CardContent className="p-6">
                      ...
                      <div className="flex items-center mb-2">
                        <Calendar className="h-4 w-4 text-primary mr-2" />
                        <span className="text-sm text-gray-600 dark:text-gray-400">Starting: {project.startDate}</span>
                      </div>
                      ...
                      <Button asChild className="w-full">
                        <Link href={`/projects/${project.slug}`}>Support This Project</Link>
                      </Button>
                    </CardContent>
                  </Card>
                ))}
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button asChild>
                  <Link href="/projects/school-rebuilding-initiative">Learn More</Link>
                </Button>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
              Through our projects, we've made significant strides in improving lives across Nepal.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div>
              ...
              <div className="text-gray-600 dark:text-gray-400">Districts Reached</div>
            </div>
            <div>
              <div className="text-4xl font-bold text-primary mb-2">15,000+</div>
              <div className="text-gray-600 dark:text-gray-400">People Directly Benefited</div>
            </div>
            <div>
              <div className="text-4xl font-bold text-primary mb-2">$1.2M</div>
              <div className="text-gray-600 dark:text-gray-400">Funds Invested</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-900">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
              We follow a systematic approach to ensure our projects create sustainable impact.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "We work directly with communities to understand their needs and priorities.",
                icon: "🔍",
              },
              {
                step: "2",
                title: "Project Design",
                description: "We design projects in collaboration with community members and relevant stakeholders.",
                icon: "📝",
              },
              {
                step: "3",
                title: "Implementation",
                description: "We implement projects with community participation and regular monitoring.",
                icon: "🛠️",
              },
              {
                step: "4",
                title: "Evaluation & Sustainability",
                description: "We evaluate impact and ensure mechanisms for long-term sustainability.",
                icon: "📊",
              },
            ].map((step, index) => (
      ...
      <section className="py-16 bg-primary text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Your contribution can help us implement more projects and reach more communities in need.
          </p>
